...
namespace airlib
{
    ...
    public:
        ...
        //====================================================================
        // VIO Support: Static interface
        //====================================================================
        static void setVIOPending(PhysicsBody* body, const Kinematics::State& state)
        {
            vio_state_ref() = state;
            vio_body_ref() = body;
            vio_pending_ref() = true;
        }

        static void setVIOEnabled(bool enabled)
        {
            vio_enabled_ref() = enabled;
            if (!enabled) {
        ...
        static bool isVIOEnabled() { return vio_enabled_ref(); }
    ...
    private:
        ...
        //====================================================================
        // VIO Support: Static accessors (Meyer's singleton for C++14)
        //====================================================================
        static bool& vio_enabled_ref()
        {
            static bool value = false;
            return value;
        }
        static bool& vio_pending_ref()
        {
            static bool value = false;
            return value;
        }
        static PhysicsBody*& vio_body_ref()
        {
            static PhysicsBody* value = nullptr;
            return value;
        }
        static Kinematics::State& vio_state_ref()
        {
            static Kinematics::State value;
            return value;
        }
    };
}
